export interface NetworkSite {
  ...
  url: string;
  flag: string;
  region: 'hub' | 'southeast-asia' | 'east-asia' | 'americas' | 'europe';
...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  {
    id: 'italy',
    name: 'Discovering Italy',
    shortName: 'Italy',
    domain: 'discoveringitaly.info',
    url: 'https://discoveringitaly.info',
    flag: '🇮🇹',
    region: 'europe',
    status: 'live',
  ...
  {
    id: 'greece',
    name: 'Discovering Greece',
    shortName: 'Greece',
    domain: 'discoveringgreece.info',
    url: 'https://discoveringgreece.info',
    flag: '🇬🇷',
    region: 'europe',
    status: 'live',
    tagline: 'Mythology, islands, and Mediterranean charm',
  },
  {
    id: 'germany',
    name: 'Discover Germany',
    shortName: 'Germany',
    domain: 'discovergermany.info',
    url: 'https://discovergermany.info',
    flag: '🇩🇪',
    region: 'europe',
    status: 'live',
    tagline: 'Castles, beer gardens, and cultural treasures',
  },
  {
    id: 'amsterdam',
    name: 'Discover Amsterdam',
    shortName: 'Amsterdam',
    domain: 'discoveramsterdam.info',
    url: 'https://discoveramsterdam.info',
    flag: '🇳🇱',
    region: 'europe',
    status: 'coming-soon',
    tagline: 'Canals, art, and Dutch golden age heritage',
  },
  // Americas
  {
    id: 'baja',
...
export const CURRENT_SITE_ID = 'germany';
