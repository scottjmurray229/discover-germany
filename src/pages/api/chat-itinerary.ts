...
function buildChatSystemPrompt(): string {
  return `You are the Discovering Germany AI Trip Planner in EDIT MODE. The user has an existing itinerary and wants to modify it.
...
- When swapping destinations, update transport/train items between days
